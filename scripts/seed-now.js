// Quick seed script with hardcoded values
const SUPABASE_URL = 'https://nzkcktausubexsfoqloo.supabase.co';
const SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im56a2NrdGF1c3ViZXhzZm9xbG9vIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1OTkxMjg3MiwiZXhwIjoyMDc1NDg4ODg3Mn0.13wWTmq6KMLLK-MfsMBOSKJ0AhdASdZ9Rwq3KGInc6k';
...
async function seed() {
  ...
  console.log('✅ Found provider:', providers[0].id);
  ...
  if (!expResponse.ok) {
    const error = await expResponse.text();
    console.error('❌ Error:', error);
    process.exit(1);
  }

  console.log('✅ Successfully seeded!');
  console.log('🎉 Done! Added', experiences.length, 'experiences');
}
