        ...
        <ScrollView className="flex-1">
          {conversations.map((conversation) => (
            <TouchableOpacity
              ...
              onPress={() => router.push(`/(provider)/messages/${conversation.id}`)}
            >
              {/* User Icon */}
              ...
              <View className="flex-1">
                <View className="flex-row items-center justify-between mb-1">
                  <Text className="text-black text-base font-bold flex-1" numberOfLines={1}>
                    {conversation.booking.guardian_name}
                  </Text>
                  {conversation.last_message_at && (
                    <Text className="text-[#999] text-xs ml-2">
                ...
                <Text className="text-[#666] text-sm mb-1" numberOfLines={1}>
                  {conversation.booking.child_name} - {conversation.booking.experience.title}
                </Text>
